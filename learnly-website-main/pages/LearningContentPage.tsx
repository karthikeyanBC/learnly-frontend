...
const LearningContentPage: React.FC = () => {
    const pageData = featurePageData['learning-content'];
    const accordionData = featurePageAccordionsData['learning-content'];
    ...
    return (
        <div className="bg-white">
            ...
            <section className="py-20 sm:py-28">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">Achieve Your Content Goals</h2>
                        <p className="mt-4 text-lg text-gray-600">Click each capability to see the business outcome it drives.</p>
                    </div>
                    <div className="mt-16">
            ...
            <section className="py-20 sm:py-28 bg-gray-50/50">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">A Complete Content Creation Suite</h2>
                        <p className="mt-4 text-lg text-gray-600">All the tools you need to build, manage, and deliver world-class training programs.</p>
                    </div>
