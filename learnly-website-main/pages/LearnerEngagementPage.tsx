...
const LearnerEngagementPage: React.FC = () => {
    const pageData = featurePageData['learner-engagement'];
    const accordionData = featurePageAccordionsData['learner-engagement'];
    ...
    return (
        <div className="bg-white">
             ...
             <section className="py-20 sm:py-28">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">A Program They'll Actually Want to Use</h2>
                        <p className="mt-4 text-lg text-gray-600">Click each capability to see how it drives learner motivation.</p>
                    </div>
                    <div className="mt-16">
            ...
            <section className="py-20 sm:py-28 bg-gray-50/50">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">Features to Drive Engagement</h2>
                         <p className="mt-4 text-lg text-gray-600">A toolkit designed to keep learners motivated and on track with their development goals.</p>
                    </div>
...
export default LearnerEngagementPage;