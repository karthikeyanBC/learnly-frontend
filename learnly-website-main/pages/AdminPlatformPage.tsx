...
const AdminPlatformPage: React.FC = () => {
    const pageData = featurePageData['admin-platform'];
    const accordionData = featurePageAccordionsData['admin-platform'];
    ...
    return (
        <div className="bg-white">
            ...
            <section className="py-20 sm:py-28">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">Scale Your Training with Total Control</h2>
                        <p className="mt-4 text-lg text-gray-600">Click each capability to see how it simplifies management.</p>
                    </div>
                    <div className="mt-16">
            ...
            <section className="py-20 sm:py-28 bg-gray-50/50">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight">Enterprise-Grade Platform Management</h2>
                        <p className="mt-4 text-lg text-gray-600">Everything you need to manage, scale, and secure your training programs with confidence.</p>
                    </div>
